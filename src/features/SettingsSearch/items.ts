...
export const SETTINGS_SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  {
    anchor: 'service-model-tts-service',
    keywords: ['tts', 'voice', 'speech', 'text to speech', 'fish audio', 'openai'],
    labelKey: 'settingTTS.ttsService.title',
    tab: SettingsTabs.ServiceModel,
  ...
  {
    anchor: 'service-model-tts-fishaudio-key',
    descKey: 'settingTTS.fishAudio.apiKey.desc',
    keywords: ['tts', 'fish audio', 'api key', 'speech'],
    labelKey: 'settingTTS.fishAudio.apiKey.title',
    tab: SettingsTabs.ServiceModel,
    visible: (ctx) => ctx.enableSTT,
  },
  {
    anchor: 'service-model-tts-fishaudio-voice',
    descKey: 'settingTTS.fishAudio.referenceId.desc',
    keywords: ['tts', 'fish audio', 'voice', 'reference id', 'speech'],
    labelKey: 'settingTTS.fishAudio.referenceId.title',
    tab: SettingsTabs.ServiceModel,
    visible: (ctx) => ctx.enableSTT,
  },
  {
